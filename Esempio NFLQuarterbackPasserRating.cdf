...
NotebookDataLength[     82986,       1631]
NotebookOptionsPosition[     55746,       1044]
NotebookOutlinePosition[     82003,       1605]
CellTagsIndexPosition[     81892,       1599]
WindowTitle->NFL Quarterback Passer Rating
WindowFrame->Normal*)
...
Cell["NFL Quarterback Passer Rating", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`comppass$$ = 20, $CellContext`intercept$$ = 
    1, $CellContext`passatt$$ = 30, $CellContext`passyrds$$ = 
    300, $CellContext`tdpass$$ = 1, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {
    "\"Example 158.3 Game: 9/26/1976 Dan Fouts SD (vs. STL)\"" :> \
{$CellContext`passatt$$ = 18, $CellContext`comppass$$ = 
       15, $CellContext`passyrds$$ = 259, $CellContext`tdpass$$ = 
       4, $CellContext`intercept$$ = 0}, 
     "\"Career NFL Record: Steve Young SF & TB\"" :> {$CellContext`passatt$$ = 
       4149, $CellContext`comppass$$ = 2667, $CellContext`passyrds$$ = 
       33124, $CellContext`tdpass$$ = 232, $CellContext`intercept$$ = 107}, 
     "\"Season NFL Record: 2004 Peyton Manning IND\"" :> \
{$CellContext`passatt$$ = 497, $CellContext`comppass$$ = 
       336, $CellContext`passyrds$$ = 4557, $CellContext`tdpass$$ = 
       49, $CellContext`intercept$$ = 10}, 
     "\"Rookie Season NFL Record: 2004 Ben Roethlisberger PIT\"" :> \
{$CellContext`passatt$$ = 295, $CellContext`comppass$$ = 
       196, $CellContext`passyrds$$ = 2621, $CellContext`tdpass$$ = 
       17, $CellContext`intercept$$ = 11}}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`passatt$$], 30, "pass attempts"}, 1, 50, 1}, {{
       Hold[$CellContext`comppass$$], 20, "completed passes"}, 0, 
      Dynamic[$CellContext`passatt$$], 1}, {{
       Hold[$CellContext`passyrds$$], 300, "passing yards"}, 1, 500, 1}, {{
       Hold[$CellContext`tdpass$$], 1, "touchdown passes"}, 0, 10, 1}, {{
       Hold[$CellContext`intercept$$], 1, "interceptions"}, 0, 10, 1}}, 
    Typeset`size$$ = {400., {237., 242.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`passatt$6040$$ = 0, $CellContext`comppass$6041$$ = 
    0, $CellContext`passyrds$6042$$ = 0, $CellContext`tdpass$6043$$ = 
    0, $CellContext`intercept$6044$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`comppass$$ = 20, $CellContext`intercept$$ = 
        1, $CellContext`passatt$$ = 30, $CellContext`passyrds$$ = 
        300, $CellContext`tdpass$$ = 1}, "ControllerVariables" :> {
        Hold[$CellContext`passatt$$, $CellContext`passatt$6040$$, 0], 
        Hold[$CellContext`comppass$$, $CellContext`comppass$6041$$, 0], 
        Hold[$CellContext`passyrds$$, $CellContext`passyrds$6042$$, 0], 
        Hold[$CellContext`tdpass$$, $CellContext`tdpass$6043$$, 0], 
        Hold[$CellContext`intercept$$, $CellContext`intercept$6044$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[$CellContext`comppass$$ > $CellContext`passatt$$, \
$CellContext`comppass$$ = $CellContext`passatt$$]; $CellContext`passydadj = 
        If[$CellContext`passyrds$$/$CellContext`passatt$$ <= 20, 20, 
          
          If[$CellContext`passyrds$$/$CellContext`passatt$$ >= 100, 
           100, $CellContext`passyrds$$/$CellContext`passatt$$]]; Column[{
          Text[
           Style[
            Row[{"quarterback passer rating: ", 
              Round[
               $CellContext`qb[$CellContext`passatt$$, \
$CellContext`comppass$$, $CellContext`passyrds$$, $CellContext`tdpass$$, \
$CellContext`intercept$$], 0.1]}], Brown, Bold, 16]], "", 
          Text[
           
           Row[{"pass percentage: ", 
             N[$CellContext`comppass$$/$CellContext`passatt$$, 3] 100, "%"}]], 
          Text[
           Row[{"average yards/pass: ", 
             If[$CellContext`passyrds$$/$CellContext`passatt$$ > 100, 
              Style["greater than 100", Bold, 14, Red], 
              N[$CellContext`passyrds$$/$CellContext`passatt$$, 3]], 
             " yards per attempt"}]], 
          Show[
           
           Plot3D[($CellContext`bound[($CellContext`passpercent - 30) 
               0.05] + $CellContext`bound[($CellContext`avgpassyrds - 3) 
               0.25] + \
$CellContext`bound[(($CellContext`tdpass$$/$CellContext`passatt$$) 100) 
               0.2] + $CellContext`bound[
              2.375 - (($CellContext`intercept$$/$CellContext`passatt$$) 100) 
               0.25]) (100/6), {$CellContext`passpercent, 0, 
             100}, {$CellContext`avgpassyrds, 0, $CellContext`passydadj}, 
            PlotStyle -> RGBColor[0.6, 0.73, 0.36], MeshFunctions -> {#3& }, 
            Mesh -> 20, MeshStyle -> White], 
           
           ParametricPlot3D[{(100 (1 - $CellContext`x^2)) 
               Cos[$CellContext`t], (
                2 $CellContext`passydadj) $CellContext`x, (
                180 (1 - $CellContext`x^2)) Sin[$CellContext`t]}/
             30 + {($CellContext`comppass$$/$CellContext`passatt$$) 
              100, $CellContext`passyrds$$/$CellContext`passatt$$, \
$CellContext`qb[$CellContext`passatt$$, $CellContext`comppass$$, \
$CellContext`passyrds$$, $CellContext`tdpass$$, $CellContext`intercept$$] + 
              5}, {$CellContext`x, -1, 1}, {$CellContext`t, 0, 2 Pi}, 
            PlotStyle -> Brown, Mesh -> False, Axes -> False, Boxed -> False], 
           Graphics3D[{{Brown, 
              PointSize[0.001], 
              
              Point[{($CellContext`comppass$$/$CellContext`passatt$$) 
                100, $CellContext`passyrds$$/$CellContext`passatt$$, \
$CellContext`qb[$CellContext`passatt$$, $CellContext`comppass$$, \
$CellContext`passyrds$$, $CellContext`tdpass$$, $CellContext`intercept$$] + 
                5}]}}], ImageSize -> {400, 400}, 
           PlotRange -> {{0, 100}, {0, $CellContext`passydadj}, {0, 180}}, 
           PlotRangePadding -> {10, $CellContext`passydadj/10, 0}, AxesEdge -> 
           Table[-1, {3}, {2}], BoxRatios -> {1, 1, 1}, Boxed -> False, 
           AxesLabel -> {"pass %", "yds/pass"}, 
           ViewPoint -> {-3.15, -1.32, 1.06}, 
           ViewVertical -> {0., 0., 1.}]}]), 
      "Specifications" :> {{{$CellContext`passatt$$, 30, "pass attempts"}, 1, 
         50, 1, Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`comppass$$, 20, "completed passes"}, 0, 
         Dynamic[$CellContext`passatt$$], 1, Appearance -> "Labeled", 
         ImageSize -> Tiny}, {{$CellContext`passyrds$$, 300, "passing yards"},
          1, 500, 1, Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`tdpass$$, 1, "touchdown passes"}, 0, 10, 1, 
         Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`intercept$$, 1, "interceptions"}, 0, 10, 1, 
         Appearance -> "Labeled", ImageSize -> Tiny}}, 
      "Options" :> {
       AutorunSequencing -> {{2, 2}, {3, 2}, {4, 1}, {5, 1}}, 
        ControlPlacement -> Left, TrackedSymbols -> Manipulate}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{657., {266., 271.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({$CellContext`bound[
          Pattern[$CellContext`x, 
           Blank[]]] = If[$CellContext`x < 0, 0, 
          If[$CellContext`x > 2.375, 2.375, $CellContext`x]]; $CellContext`qb[
          Pattern[$CellContext`passatt, 
           Blank[]], 
          Pattern[$CellContext`comppass, 
           Blank[]], 
          Pattern[$CellContext`passyrds, 
           Blank[]], 
          Pattern[$CellContext`tdpass, 
           Blank[]], 
          Pattern[$CellContext`intercept, 
           
           Blank[]]] = \
($CellContext`bound[(($CellContext`comppass/$CellContext`passatt) 100 - 30) 
            0.05] + $CellContext`bound[($CellContext`passyrds/$CellContext`\
passatt - 3) 
            0.25] + $CellContext`bound[(($CellContext`tdpass/$CellContext`\
passatt) 100) 0.2] + $CellContext`bound[
           2.375 - (($CellContext`intercept/$CellContext`passatt) 100) 
            0.25]) (100/6); Null}; Typeset`initDone$$ = True),
...
Cell["\<\
The formula for the National Football League (NFL) quarterback passer rating \
depends on five variables: number of attempted passes, completed passes, \
passing yards, touchdown passes, and interceptions. Passer ratings can range \
from a low score of 0.0 to a high score of 158.3. You input values for each \
statistic to create a score. The Demonstration visually maps the result in a \
three-dimensional graph to help you better understand the relationship of \
each variable to the final result.\
\>", "ManipulateCaption"],

Cell["\<\
The sliders are set for values that may occur within a single game. You can \
open each and directly input higher values to reflect data added over many \
games. A few NFL records are bookmarked along with one example of a perfect \
game.\
\>", "ManipulateCaption",
 CellID->591301099],
...
Cell[TextData[{
 ...
 ButtonBox["http://www.nfl.com/help/quarterbackratingformula",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.nfl.com/help/quarterbackratingformula"], None}]
}], "DetailNotes",
 CellID->256183249],

Cell["Snapshot 1: graph adjusts for extreme cases", "DetailNotes",
 CellID->64887497],

Cell["\<\
Snapshot 2: Steve Young holds the record for career high passer rating \
(bookmarked)\
\>", "DetailNotes",
 CellID->5297143],

Cell["\<\
Snapshot 3: example 158.3 game (Dan Fouts in 1976, one of 34 quarterbacks \
with perfect ratings as of 2007 season)\
\>", "DetailNotes",
 CellID->197379928],
...
NFLQuarterbackPasserRating&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/NFLQuarterbackPasserRating/\
NFLQuarterbackPasserRating-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["NFL Quarterback Passer Rating",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/NFLQuarterbackPasserRating/"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/NFLQuarterbackPasserRating/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/NFLQuarterbackPasserRating/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/NFLQuarterbackPasserRating/"], 
    None},
...
Cell["Suggested by: Dan McLellan", "Author",
 FontColor->GrayLevel[0.6],
 CellID->368628908],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44239, 769, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44500, 778, 3687, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54924, 1019, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81605, 1588},
 {"Copyright", 81800, 1593}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34977, 592, 8421, 157, 70, "Output",
 CellID->71932601],
Cell[43401, 751, 537, 8, 70, "ManipulateCaption"],
Cell[43941, 761, 295, 6, 70, "ManipulateCaption",
 CellID->591301099],
Cell[44239, 769, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44500, 778, 3687, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48190, 862, 33, 0, 70, "DetailsSection"],
Cell[48226, 864, 267, 7, 70, "DetailNotes",
 CellID->256183249],
Cell[48496, 873, 85, 1, 70, "DetailNotes",
 CellID->64887497],
Cell[48584, 876, 134, 4, 70, "DetailNotes",
 CellID->5297143],
Cell[48721, 882, 166, 4, 70, "DetailNotes",
 CellID->197379928],
Cell[48890, 888, 4817, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53710, 979, 45, 0, 70, "CitationSection"],
Cell[53758, 981, 832, 22, 70, "Citations"],
Cell[54593, 1005, 233, 8, 70, "Author"],
Cell[54829, 1015, 92, 2, 70, "Author",
 CellID->368628908],
Cell[54924, 1019, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature BSqVI9yW@TM#ewASHK0cQ1DA *)
